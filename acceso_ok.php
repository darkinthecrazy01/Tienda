...
<div class="container">
  ...
  <div class="subcontenedor">
    ...
    <!-- end .sidebar1 --></div>
  <div class="content">
    <h1><!-- InstanceBeginEditable name="olantilla" -->Bienvenido(a)<!-- InstanceEndEditable --></h1>
    <!-- InstanceBeginEditable name="Contenido" -->Estas ya solo a un click de ser unico<!-- InstanceEndEditable -->
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
