...
<div class="container">
  ...
  <div class="subcontenedor">
    ...
    <!-- end .sidebar1 --></div>
  <div class="content">
    <h1><!-- InstanceBeginEditable name="olantilla" -->A ocurrido un error en tu acceso<!-- InstanceEndEditable --></h1>
    <!-- InstanceBeginEditable name="Contenido" --><a href="acceso.php">Intenta de nuevo</a><!-- InstanceEndEditable -->
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
